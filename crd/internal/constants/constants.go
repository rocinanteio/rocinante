...
func GetServiceAccountName(app *rociiov1beta1.ReviewApp) string {
	return strings.Join([]string{serviceAccountName, app.Name}, "-")
}

func GetAppName(app *rociiov1beta1.ReviewApp) string {
	return strings.Join([]string{appName, app.Name}, "-")
}

func GetDeploymentName(app *rociiov1beta1.ReviewApp) string {
	return strings.Join([]string{deploymentName, app.Name}, "-")
}

func GetClusterRoleName(app *rociiov1beta1.ReviewApp) string {
	return strings.Join([]string{clusterRoleName, app.Name}, "-")
}

func GetClusterRoleBindingName(app *rociiov1beta1.ReviewApp) string {
	return strings.Join([]string{clusterRoleBindingName, app.Name}, "-")
}

func GetCoreServiceName(app *rociiov1beta1.ReviewApp) string {
	return strings.Join([]string{coreServiceName, app.Name}, "-")
}

func GetCoreSocketServiceName(app *rociiov1beta1.ReviewApp) string {
	return strings.Join([]string{coreSocketServiceName, app.Name}, "-")
}

func GetUiServiceName(app *rociiov1beta1.ReviewApp) string {
	return strings.Join([]string{uiServiceName, app.Name}, "-")
}

func GetCoreServicePort(app *rociiov1beta1.ReviewApp) int {
	return coreServicePort
}

func GetCoreServiceSocketPort(app *rociiov1beta1.ReviewApp) int {
	return coreServiceSocketPort
}

func GetCoreServiceNodePort(app *rociiov1beta1.ReviewApp) int {
	return int(app.Spec.Variables.CoreApiPort)
}
func GetCoreServiceSocketNodePort(app *rociiov1beta1.ReviewApp) int {
	return int(app.Spec.Variables.CoreApiSocketPort)
}

func GetUiServicePort(app *rociiov1beta1.ReviewApp) int {
	return uiServicePort
}

func GetUiServiceNodePort(app *rociiov1beta1.ReviewApp) int {
